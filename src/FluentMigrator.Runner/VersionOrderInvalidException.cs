...
namespace FluentMigrator.Runner
{
    ...
    {
        public IEnumerable<KeyValuePair<string, IMigrationInfo>> InvalidMigrations { get; set; }

        public IEnumerable<long> InvalidVersions { get; private set; }

        public VersionOrderInvalidException(IEnumerable<KeyValuePair<string, IMigrationInfo>> invalidMigrations)
        {
